...
class TestBright(DatasetIntegrationTest):
    ...
    def test_queries(self):
        self._build_test_queries('bright/aops')
        self._build_test_queries('bright/biology')
        self._build_test_queries('bright/earth-science')
        self._build_test_queries('bright/economics')
        self._build_test_queries('bright/leetcode')
        self._build_test_queries('bright/pony')
        self._build_test_queries('bright/psychology')
        self._build_test_queries('bright/robotics')
        self._build_test_queries('bright/stackoverflow')
        self._build_test_queries('bright/sustainable-living')
        self._build_test_queries('bright/theoremqa-questions')
        self._build_test_queries('bright/theoremqa-theorems')
        self._build_test_queries('bright/biology-long')
        self._build_test_queries('bright/earth-science-long')
        self._build_test_queries('bright/economics-long')
        self._build_test_queries('bright/pony-long')
        self._build_test_queries('bright/psychology-long')
        self._build_test_queries('bright/robotics-long')
        self._build_test_queries('bright/stackoverflow-long')
        self._build_test_queries('bright/sustainable-living-long')
